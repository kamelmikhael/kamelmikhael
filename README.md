...
- 🎯 **I’m currently working on**: Mastering the intricacies of Modular Monoliths, DDD, Microservices Applications, DevOps, CI/CD, Cloud (AWS, Azure) and some advanced software architectures
...
### 🛠️ Top Technical Skills & Tools
  ...
  <p align="left">
    <img src="https://go-skill-icons.vercel.app/api/icons?i=angular,react,cs,blazor,dotnet,docker,sqlserver,dapper,redis,html,css,js,ts,postman,swagger,git&perline=7" 
      style="height:113px;"/>
  </p>
